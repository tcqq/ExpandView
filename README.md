...
[ ![Download](https://api.bintray.com/packages/tcqq/android/expandview/images/download.svg?version=3.0.0) ](https://bintray.com/tcqq/android/expandview/3.0.0/link)
...
dependencies {
    // Using JCenter
    implementation 'com.tcqq.android:expandview:3.0.0'
}
```
